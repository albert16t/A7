...
";
    ...
    <div class=\"container\">
        ...
        // line 12
        echo "            <div><h3>";
        echo twig_get_attribute($this->env, $this->source, (isset($context["post"]) || array_key_exists("post", $context) ? $context["post"] : (function () { throw new RuntimeError('Variable "post" does not exist.', 12, $this->source); })()), "content", []);
        echo "</h3></div>
            <div><b>";
        // line 13
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["post"]) || array_key_exists("post", $context) ? $context["post"] : (function () { throw new RuntimeError('Variable "post" does not exist.', 13, $this->source); })()), "author", []), "html", null, true);
        echo "</b> creado el <b> ";
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["post"]) || array_key_exists("post", $context) ? $context["post"] : (function () { throw new RuntimeError('Variable "post" does not exist.', 13, $this->source); })()), "createdAt", []), "Y-m-d"), "html", null, true);
        echo "</b></div>
            ";
        // line 14
        if ((twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 14, $this->source); })()), "user", []) == twig_get_attribute($this->env, $this->source, (isset($context["post"]) || array_key_exists("post", $context) ? $context["post"] : (function () { throw new RuntimeError('Variable "post" does not exist.', 14, $this->source); })()), "user", []))) {
            // line 15
            echo "            <div>
                <a class=\"btn btn-secondary\" href=\"";
            // line 16
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_post_edit", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["post"]) || array_key_exists("post", $context) ? $context["post"] : (function () { throw new RuntimeError('Variable "post" does not exist.', 16, $this->source); })()), "id", [])]), "html", null, true);
            echo "\">Edit</a>
            </div>
            ";
        }
        ...
        echo "
                ";
        // line 27
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 27, $this->source); })()), "comment", []), 'row');
        echo "
                ";
        // line 28
...
";
    ...
    {
        return array (  161 => 29,  157 => 28,  153 => 27,  149 => 26,  146 => 25,  137 => 22,  133 => 21,  130 => 20,  125 => 19,  119 => 16,  116 => 15,  114 => 14,  108 => 13,  103 => 12,  99 => 10,  92 => 7,  83 => 6,  71 => 4,  66 => 3,  57 => 2,  27 => 1,);
    }
...
{% block body %}
    ...
    <div class=\"container\">
        <div class=\"titulo\">
            <h1>{{ post.title }}</h1>
            {#<a class=\"btn btn-danger\" href=\"{{ path('app_post_delete',{'id':post.id} ) }}\">X</a>#}
...
{% endblock %}
", "post/showpost.html.twig", "/home/linux/www/projects/blog/templates/post/showpost.html.twig");
    }
}
